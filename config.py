...
STATE_FILE = STATE_DIR / os.getenv("PUBLICATION_STATE_FILENAME", "publication_state.json")
...
class Settings:
    ...
    state_branch: str = os.getenv("STATE_BRANCH", "daily-facts-state")
    block_batch2_without_batch1_receipt: bool = _env_bool("BLOCK_BATCH2_WITHOUT_BATCH1_RECEIPT", True)
